        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeadOfficeCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentDistributorId = table.Column<int>(type: "int", nullable: true),
                    ShelfCount = table.Column<int>(type: "int", nullable: false),
                    ProductSelectionCount = table.Column<int>(type: "int", nullable: false),
                    ...
                    ShelfReturnDueDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ShelfReturnedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ShelfReturnStatus = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ParentDistributorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresFreezing = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DistributorSubscriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DistributorSubscriptions_Distributors_DistributorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QRCodeImageUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeactivatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DistributorId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QRCodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QRCodes_Distributors_DistributorId",
                        column: x => x.DistributorId,
                        principalTable: "Distributors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Settlements_Distributors_DistributorId",
                        column: x => x.DistributorId,
                        principalTable: "Distributors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Settlements_Manufacturers_ManufacturerId",
                        column: x => x.ManufacturerId,
                        principalTable: "Manufacturers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SampleOrders_Distributors_DistributorId",
                        column: x => x.DistributorId,
                        principalTable: "Distributors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DistributorCommission = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sales_QRCodes_QRCodeId",
                        column: x => x.QRCodeId,
                        principalTable: "QRCodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DistributorSubscriptions_DistributorId",
                table: "DistributorSubscriptions",
                column: "DistributorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sales_QRCodeId",
                table: "Sales",
                column: "QRCodeId");

            migrationBuilder.CreateIndex(
                name: "IX_SampleOrders_DistributorId",
                table: "SampleOrders",
                column: "DistributorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Settlements_DistributorId",
                table: "Settlements",
                column: "DistributorId");

            migrationBuilder.CreateIndex(
                name: "IX_Settlements_ManufacturerId",
                table: "Settlements",
                column: "ManufacturerId");
        }
